$(document).ready(function(){
    ...
    $(document).on('click', '#insertarP', function(e){
        e.preventDefault();
            ...
            $.post('http://localhost:8080/PROYECTO-SIR/SIR/Controller/orderAjax.php', postData, function(response){
                    // listar();
    ...
    $(document).on('click', '#cargarP', function(e){
        $.ajax({
            url : 'http://localhost:8080/PROYECTO-SIR/SIR/Controller/orderAjax.php',
            type : 'GET',
    ...
    function listar(){
        let listar="listar";
        let total=0;
            $.post('http://localhost:8080/PROYECTO-SIR/SIR/Controller/orderAjax.php', listar, function(response){
                // $('#categoria-form').trigger('reset');
                console.log(response);
                if (response) {
                  let productos = JSON.parse(response);
                  ...
                  productos.forEach(productos => {
                      ...
                      template += `
                          ...
                          <td>${productos.precio_unitario}</td>
                          <td>${$precio_total=productos.precio_unitario*productos.cantidad}</td>
                         <td>
    ...
    $(document).on('click', '.categoria-edit', function(){
        ...
        $.post('http://localhost:8080/PROYECTO-SIR/SIR/Controller/orderAjax.php', {consul}, function(response) {
