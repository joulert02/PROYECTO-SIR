<?php
    class vistasModel{
        protected function obtener_vistas_modelo($vistas){
            ...
            $listaBlanca=["E403","404","403","resetPassword","codePassword","Inicio","recoverPassword","changePassword","upload","profile","editAccount","logout","homeAdmin","recoverPassword","Categoria","tipoDocumento","tipoSalida","addPedido","addCategory","addEntry","addExit","addPerson","addProduct","addCategory",
