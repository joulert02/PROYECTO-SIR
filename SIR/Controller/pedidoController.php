...
if (isset($_REQUEST['id'])) {
	...
	try {
		    ...
		    $con->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
				...
				$resultado = $con->prepare("SELECT pro.nombre_producto, pro.referencia, dt.cantidad FROM tbl_producto pro JOIN tbl_detalle_pedido dt ON 
				pro.id_producto=dt.Producto_id_producto WHERE dt.Pedido_id_pedido=?");
