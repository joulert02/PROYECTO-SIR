...
class productoController extends productoModel
{
	...
	public function agregar_producto_controlador(){
		...
		$consulta1 = mainModel::ejecutar_consulta_simple("SELECT `referencia` FROM `tbl_producto` WHERE referencia='$referencia'");
		if ($consulta1->rowCount() >= 1) {
			...
			$alerta = [
				...
				"Texto" => "Está Referencias Ya se encuentra registrada en el sistema",
				"Tipo" => "error"
			];
		}else {
			$dataPerson=[
