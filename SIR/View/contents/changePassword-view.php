  ...
  <div class="col-md-16">
      ...
      <form method="post" action="#" id="validate_form" >
         ...
         <div class="col-md-6 mb-3" style="display: flex;">
              ...
              <input style="border-right:0;" type="password" ID="txtPassword" class="form-control" name="old-password" required data-parsley-length="[6, 15]" placeholder="Antigua contraseña"><button style="height: 35px; border-left:0;"id="show_password" class="btn btn-light" type="button" onclick="mostrarPassword()"><li style="color:black;" class="fa fa-eye-slash icon"></li></button>  
        </div> 

        <div class="col-md-6 mb-3" style="display: flex;">
          <label for="newPassword" class="control-label">Nueva contraseña</label>&nbsp
              <input style="border-right:0;" type="password" class="form-control" name="password" ID="txtPassword2" required data-parsley-length="[6, 15]"  placeholder="Nueva Contraseña"><button style="height: 35px;"  id="show_password" class="btn btn-light" type="button" onclick="mostrarPassword2()" ><li style="color:black;" class="fa fa-eye-slash iconn"></li></button>
        </div>
        <br>
        <br>
        <br>
