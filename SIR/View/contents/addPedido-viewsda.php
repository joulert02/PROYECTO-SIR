				...
				<div class="panel-body">
					<form method="post" class="form-horizontal" role="form" id="datos_pedido" ID="validate_form">
						<div class="form-row">
							...
							<div class="col-md-4">
								<label for="condiciones" class="control-label " style="visibility: hidden">N° Comprobante</label>
								<input type="number" class="form-control " id="condiciones" value="500" required style="visibility: hidden"><br>
							</div>
	...
	<script>
		...
		$("#datos_pedido").submit(function(e) {
			...
			var totall = $('#totalj').attr('tr');
			if (parseInt(totall) < 200 || proveedor<=0) {
				if (proveedor<=0) {
					swal({
              title: 'precaución',
