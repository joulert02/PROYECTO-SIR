...
-Que nuestro aplcativo cumpla con sus funcones
        ...
        <a class="collapsed" data-toggle="collapse" data-parent="#accordion" href="#tab-quienessomos" > QUIENES SOMOS
                ...
                <aside class="col-md-2">
                    <img style="height: 65%;" src="public/img/rodillo.jpg" alt="Nosotros">
...
<!-- formulario registro -->
                    ...
                    <form method="post"  id="validate_form" autocomplete="off">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input style="border: gray solid;" class="form-control" type="text"  name="nombre" placeholder="Ingrese su nombre " data-toggle="tooltip" data-placement="top" title="Ingrese su nombre " required="">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input style="border: gray solid;" class="form-control" type="number"  name="telefono" placeholder="Ingrese su teléfono" data-toggle="tooltip" data-placement="top" title="Ingrese su teléfono" required="">
                            </div>
                        </div>
...
<section class="ultimos-proyectos py-1">
    <section class="agencia py-1" id="agencia">
        ...
        <div class="container"> 
            ...
            <div class="row">
                <div class="col-xs-12 text-xs-right">
                    <a href="index_restaurante.php">Inicio</a> » Galeria
