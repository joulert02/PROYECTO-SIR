    ...
    <!-- MIOS -->
    <link rel="stylesheet" type="text/css" href="<?php echo SERVERURL; ?>public/css/menu-view.css">
    ...
    <!-- LIBRERIAS -->
    <link rel="stylesheet" type="text/css" href="<?php echo SERVERURL; ?>public/css/jquery.dataTables.css"> 
