...
class consulta
{
      ...
      function comprobantePdfPedido()
      {
            ...
            try {
                  ...
                  $insert = mysqli_query($this->conn, "INSERT INTO tbl_pedido VALUES ('','$proveedor','$descuento','Liliana Ospina','$date','$date','$transporte','$estadoP','$comentarios')");

                  $html = $html . '  <p style="font-size:11pt;text-align:right">COMPROOBANTE Nº</p>';
                  $html = $html . '
    ...
    <br>
            ...
            VALUES (?,?,?,?,?,?,?,?,?)";
                  ...
                  $descuentoN=$sumador_total*($descuento/100);
                  $sumador_total=$sumador_total-($sumador_total*($descuento/100));
                  $html = $html . ' 
            ...
            <td>$'.$descuento.'% = '.number_format($descuentoN).'</td>
            </tr>
            <tr>
